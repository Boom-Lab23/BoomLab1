...
# Prisma runtime
# Copia TODO o node_modules do builder que tem Prisma + dependencias (inclui @prisma/config,
# @prisma/engines, @prisma/internals, etc.) em vez de copiar pacote-a-pacote.
