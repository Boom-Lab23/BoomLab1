...
export function Header() {
  ...
  return (
    <header className="flex h-14 items-center justify-between border-b bg-card px-6">
      {/* Search */}
      <div className="flex items-center gap-2 rounded-lg border bg-background px-3 py-1.5 transition-colors focus-within:border-primary focus-within:ring-1 focus-within:ring-primary/20">
      ...
      <div className="flex items-center gap-2">
        ...
        {session?.user ? (
          <div className="flex items-center gap-2 rounded-lg border p-1 pl-2.5">
          ...
          <div className="flex items-center gap-2 rounded-lg border px-3 py-1.5">
            ...
            <span className="text-xs text-muted-foreground">Sem sessao</span>
          </div>
        )}
      </div>
    </header>
